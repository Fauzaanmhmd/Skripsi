            ...
            <div>
                ...
                <div className="header_review">
                    <div className="header_review_item">
                        <img src="img/ojan.jpeg"></img>
                        <p>service, fast response, staff are very helpfull</p>
                    </div>
                    <div className="header_review_item">
                        <img src="img/olis.jpeg"></img>
                        <p>Service was quick and flexible All staff very helpfull, many occasion i ordered in last minute, they always givw suggestion for the best result and resolution of the printing quality BRAVO Rembo Team...!</p>
                    </div>
                    <div className="header_review_item">
