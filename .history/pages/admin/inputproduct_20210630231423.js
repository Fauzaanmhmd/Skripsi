            ...
            <div className="feedback">
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="fname" name="namaProduct" placeholder="Your name.."></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <textarea id="subject" name="deskripsiGambar" placeholder="Write something.."></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <input type="file" name="Gambar" id="filegambar"></input>
                        </div>
                    </div>
                    <br></br>
                    <div class="row">
