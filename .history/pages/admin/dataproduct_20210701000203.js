...
export default function DataProduct({ Product }) {
    const [dataProducts, setDataProducts] = useState(localStorage.getItem("dataProducts") || [
        {
    ...
    useEffect(() => {
        ...
        localStorage.setItem('dataProducts', JSON.stringify(checkProduct || dataProducts));
    }, [dataProducts])
    return (
        <LayoutAdmin>
