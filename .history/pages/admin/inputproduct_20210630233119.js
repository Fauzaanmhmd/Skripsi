...
const InputProduct = () => {
    ...
    const handleSubmit = () => {
        ...
        dataProducts[productLength + 1].namaProduct = namaProduct
        dataProducts[productLength + 1].deskripsiGambar = deskripsiGambar
        dataProducts[productLength + 1].Gambar = Gambar
