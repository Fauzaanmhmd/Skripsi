            ...
            <div className="termof_use">
                <section>
                    ...
                    <p>
                        ...
                        Cost of Content. The Reswara Website allows you to view or use Content for free on the Reswara Store. Additional restrictions may apply to your access to and use of certain free Content.

                        Purchase of Content. When you purchase Content or use the Reswara Website, you will get into a separate sales contract based on these Terms (as applicable) with the seller either from:
                        ...
                        Your contract for the purchase and use of the Content will be completed after you receive an email from Reswara confirming the purchase of the Content, and the contract will take effect as soon as the purchase is complete.

                        Reswara Website Payment. In order to purchase Content through the Reswara Website, you must have a Reswara Website Payment account and agree to the Terms of Use of the Reswara Website Payment, the Reswara Website Privacy Policy applies whenever you purchase Content using the Reswara Website Payment account. You are responsible for all amounts to be paid in connection with purchases made through the Reswara Website from your Reswara Website account.
                        ...
                        Prices and the availability of all content shown on the Reswara Website may change at any time prior to purchase.
                    ...
                    <p>
                        ...
                        Violation of License Terms. If you violate any of the Terms, your rights under this license will terminate immediately, and Reswara may terminate your access to the Reswara website, your Reswara Website Content or Account without a refund to you.
                        ...
                        Sell, rent, redistribute, broadcast, transmit, communicate, modify, sub-license, transfer, divert any Content to any third party including those related to any download of Content that you can obtain through the Reswara Website unless specifically permitted and only provided in the right manner.
                        Use the Reswara Website or any Content together with stream-ripping, stream capture or similar software to record or make copies of any Content presented to you in a streaming format.
                        ...
                        Trying to, or assisting, authorizing or encouraging others to avoid, disable or defeat any security feature or component that protects, obscures or restricts access to the Reswara Content or Websites.
                        Remove watermarks, labels, or other legal or proprietary notices included in any Content or attempts to modify any Content obtained through the Reswara Website, including any modification for the purpose of disguising or changing the indication of ownership or source of Content.
                    ...
                    <p>
                        ...
                        Each party requires its employees to maintain a good reputation of Reswara in using Reswara’s services as referred to in these Terms and Conditions honestly, in good faith, and obeying and complying with policies, guidelines, ethical standards and regulations.

                        You hereby declare, warrant and undertake to Reswara that:
                    ...
                    <p>
                        ...
                        The products that you buy and sell are fake, violate the intellectual property rights of other third parties, do not comply with the provisions of applicable laws and regulations, and/or are contrary to the provisions applicable in Reswara (such as the Reswara Terms of Use);
                ...
                <section>
                    ...
                    <p>
                        ...
                        The following is a list of non-exclusive content, and conduct that is prohibited (but not limited to) by Reswara:
                        ...
                        Engineering, reverse compiling or deriving source code or structure or sequence of Reswara services, solutions or technologies of any kind.
                    ...
                    <p>
                        ...
                        Reswara has its own right and policy to:
                        ...
                        Terminate any account if the content on its website generates, or is the subject of, legal action or harmful legal action against Reswara or its affiliates or partners, regardless of whether the legal action or harmful legal action is determined to be with or without services later on.
                        Terminate any account for unsolicited commercial email (e.g Spam), illegal access to other computers or networks (e.g., Hacking), internet virus distribution or similar destructive activity, legitimate or unauthorized activities that Reswara deems harmful to customers operation or reputation, or for any breach of this agreement.
                    ...
                    <p>
                        12. Reswara Connexi Terms

                        Reswara provides Reswara Connexi Services to you under these Reswara Connexi Terms. If you use the services provided by the Reswara Connexi Service, you agree to the Reswara Connexi Service Terms and Conditions (“Reswara Connexi Terms”). To the extent of the conflict between the Reswara Connexi Terms and the Reswara Terms and Conditions, the latter will be applied. The terms in capital letters have the meaning stated in the Reswara Connexi Terms or here contextually.

                        You agree to use the Reswara Connexi Services in accordance with (i) our technical and product documentation, and other related documentation provided by Reswara and its affiliates (collectively the “Documentation”); and (ii) Reswara Connexi Service Policy.

                        Limitation. With respect to the data you obtain from using the Reswara Connexi Service Policy, you may not directly or indirectly (i) share, transfer, sell, license or distribute any data, including any anonymous, aggregate, or derivative form of such data to any third party; or (ii) retargeting on or off the Reswara Companies service, using piggybacking or redirecting, or combining that data with other third party data sources. We can terminate your account and immediately revoke your access if we determine that you have violated this restriction. This section survives from the termination of these Reswara Connexi Terms.

                        Reporting. You agree to provide us with reports related to your use of the Reswara Connexi Service, because we can make reasonable requests from time to time, no later than 30 days after the date of our request.

                        Reswara may update these Reswara Connexi Terms (“Modify”); by continuing to use the Reswara Connexi Service after the Change, you agree to the Change.
                    </p>
                    ...
                    <p>
                        ...
                        Reswara has the absolute authority to revise, change, and/or add provisions to the Information Confidentiality Policy without the user’s consent.
                    </p>
                </section>
            </div>
        </Layout>
